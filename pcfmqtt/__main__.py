...
def main():
    parser = argparse.ArgumentParser(description='Home-Assistant MQTT bridge for Panasonic Comfort Cloud')
    ...
    s = pcfmqtt.service.Service(args.username, args.password, args.server, args.port, args.topic)
    s.start()
